...
It was based on the basic characteristics of the Airbnb platform.
...
The first iteration of the project consisted of building an interactive console in order to allow for development testing.
...
This part of the project consists building the basic CSS and HTML source code.
...
This section consists data modeling for the relational database in MySQL.
...
This iteration consists building the first approach to dynamic content for the application by using Flask and Jinja, and effectively having Server Side Render.
...
This Application Programming Interface(API) was built with Flask and SQLAlchemy in order to work with MySQL and respond to HTTP requests.
...
This is the final iteration of the project and consisted in changing the Server Side Render for Client Based Render using JavaScript with jQuery, and the RESTful API from before.
...
🔹 __Maxwell Duedu__ <[BaduDueduMaxwell](https://github.com/BaduDueduMaxwell)>
